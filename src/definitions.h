...
using MyQuantity = Quantity<PPAdapter>;
...
template<typename WeightFunc>
using basket_AlgebraicShapeOperatorFit =
        Ponca::BasketDiff<Ponca::Basket<PPAdapter, WeightFunc, Ponca::OrientedSphereFit>, Ponca::DiffType::FitSpaceDer,
                          Ponca::OrientedSphereDer, Ponca::MlsSphereFitDer, Ponca::CurvatureEstimatorBase,
...
template<typename WeightFunc>
using basket_meanPlaneFit =
        Ponca::BasketDiff<Ponca::Basket<PPAdapter, WeightFunc, Ponca::MeanPlaneFit>, Ponca::DiffType::FitSpaceDer,
                          Ponca::MeanPlaneDer, Ponca::CurvatureEstimatorBase,
                          Ponca::NormalDerivativesCurvatureEstimator>;

template<typename WeightFunc>
using basket_ellipsoidFit =
        Ponca::BasketDiff<Ponca::Basket<PPAdapter, WeightFunc, Ponca::OrientedEllipsoidFit>,
                          Ponca::DiffType::FitSpaceDer, Ponca::OrientedEllipsoidDer, Ponca::CurvatureEstimatorBase,
                          Ponca::NormalDerivativesCurvatureEstimator>;
...
template<typename WeightFunc>
using basket_hyperboloidFit_Diff =
        Ponca::BasketDiff<Ponca::Basket<PPAdapter, WeightFunc, Ponca::OrientedHyperboloid_ACP_Fit>,
                          Ponca::DiffType::FitSpaceDer, Ponca::OrientedEllipsoidDer, Ponca::CurvatureEstimatorBase,
                          Ponca::NormalDerivativesCurvatureEstimator>;
